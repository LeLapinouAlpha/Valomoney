...
import fr.valorantage.valomoney.gui.custom.ShopBlockMenu;
...
public class ModMenuTypes {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<ShopBlockMenu>> SHOP_MENU = registerMenuType("shop_menu",
            ShopBlockMenu::new);
