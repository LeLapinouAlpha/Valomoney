...
public class ValomoneyMod
{
    ...
    public static final RegistryObject<CreativeModeTab> VALOMONEY_TAB = CREATIVE_MODE_TABS.register("valomoney_tab", () -> CreativeModeTab.builder()
            ...
            .icon(() -> BILL_FIVE.get().getDefaultInstance())
            .displayItems((parameters, output) -> {
                output.accept(BILL_FIVE.get());
                output.accept(BILL_TEN.get());
                output.accept(BILL_TWENTY.get());
                output.accept(BILL_FIFTY.get());
                output.accept(BILL_HUNDRED.get());
            }).build());
