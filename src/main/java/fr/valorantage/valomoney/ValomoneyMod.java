...
import fr.valorantage.valomoney.gui.custom.ShopScreen;
...
public class ValomoneyMod {
    ...
    public ValomoneyMod(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Register the Deferred Register to the mod event bus so attachments get
        // registered
        ModAttachmentTypes.register(modEventBus);
        // Register the Deferred Register to the mod event bus so data components get
        // registered
        ...
        // (ValomoneyMod) to respond directly to events.
